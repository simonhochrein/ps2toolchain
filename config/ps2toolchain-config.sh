...
PS2TOOLCHAIN_IOP_REPO_URL="https://github.com/simonhochrein/ps2toolchain-iop.git"
PS2TOOLCHAIN_IOP_DEFAULT_REPO_REF="main"
PS2TOOLCHAIN_EE_REPO_URL="https://github.com/simonhochrein/ps2toolchain-ee.git"
